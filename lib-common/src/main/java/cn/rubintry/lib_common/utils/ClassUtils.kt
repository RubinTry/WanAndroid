package cn.rubintry.lib_common.utils
...
import cn.rubintry.lib_common.thread.Logger
import cn.rubintry.lib_common.thread.NormalPoolExecutor
...
object ClassUtils {
    ...
    fun getClass(context: Context, packageName: String): Set<String> {
        ...
        for (path in paths) {
            NormalPoolExecutor.getInstance().execute(Runnable {
